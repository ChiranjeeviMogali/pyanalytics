...
#what to learn in LINEAR MODELLING?
#1.Predicting Continous, Finding relationship between variables
#2.steps: load data, split: DV & IV; Train and test data
#3.Load the libraries
#4.create model :function + IV & DV from Train
#5.see r2, adjust R2, coeff, significant, other model
#6. predict: Model+ IV_test -> predicted_y
#7. rmse : predicted_y - linear, normality, homoscedacity, multi collinearity and auto-collinearity
#%%%% Links

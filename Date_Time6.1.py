...
x1.month
x1.day
print(x1.strftime("%A %B"))    #strftime :String From time caps
print(x1.strftime("%a %b"))    #strftime : String From Time Short
#particular Date
x2 = datetime.datetime(1947,8,15, 15,27,35)     # Default Format
x2.day
x2.month

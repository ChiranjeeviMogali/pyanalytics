...
x=[1,2,3]; y=[4,8,6]
fig = plt.figure()
plt.subplot(2, 2, 1) #matrix of 2x2 plot : 1st plot
plt.plot(x, y)
plt.subplot(2, 2, 2) #matrix of 2x2 plot : 2nd plot
plt.plot(x, y)
plt.subplot(2, 2, 3) #matrix of 2x2 plot : 3rd plot
plt.plot(x, y)
plt.subplot(2, 2, 4) #matrix of 2x2 plot : 4th plot
plt.plot(x, y)
plt.show();
...
ax[1, 1].plot(range(10), 'w') #row=1, col=1
